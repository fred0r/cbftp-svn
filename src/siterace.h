...
class SiteRace : public CommandOwner, public std::enable_shared_from_this<SiteRace> {
  ...
  public:
    ...
    void addTransferStatsFile(StatsDirection direction, const std::string& other, unsigned long long int size, unsigned long long int speed) override;
    unsigned long long int getSizeDown() const;
    unsigned int getFilesDown() const;
    unsigned long long int getSpeedDown() const;
    unsigned long long int getSizeUp() const;
    unsigned int getFilesUp() const;
    unsigned long long int getSpeedUp() const;
    ...
    std::unordered_map<std::string, unsigned long long int>::const_iterator speedUpBegin() const;
    ...
    std::unordered_map<std::string, unsigned long long int>::const_iterator speedDownBegin() const;
    ...
    std::unordered_map<std::string, unsigned long long int>::const_iterator speedUpEnd() const;
    ...
    std::unordered_map<std::string, unsigned long long int>::const_iterator speedDownEnd() const;
